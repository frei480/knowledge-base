...
-   проверьте, установлен ли у вас `docker-compose`, если установлен - удалите, например:
```sh
docker-compose --version
sudo apt remove docker-compose
```
# Установка
-   для установки `docker-compose-v2` следует выполнить:
```sh
sudo apt install docker-compose-v2
```
# Пример Работы С Docker-compose-v2
## Пункт 1
