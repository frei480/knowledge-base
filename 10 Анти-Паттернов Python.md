...
### 00:26 Анти-паттерн 1 - Использование исключений для потока управления
...
if __name__ == "__main__":
    main()
```
### 04:02 Анти-паттерн 2 - Использование классов только со статическими методами
...
if __name__ == "__main__":
    main()
```
### 05:01 Анти-паттерн 3 - Неожиданное переопределение методов dunder
...
if __name__ == "__main__":
    main()
```
### 09:31 Анти-паттерн 4 - Использование жестко закодированных значений
...
### 5 Анти-паттерн: использование декораторов для внедрения данных
...
if __name__ == "__main__":
    main()
```
### 6 Анти-паттерн: чрезмерная разработка шаблонов проектирования
...
if __name__ == "__main__":
    main()
```
### 7 Анти-паттерн: неуместной интимности
...
### 8. Анти-паттерн: слишком много прямой связи
...
from dataclasses import dataclass
```
### 10 Анти-паттерн: не использование встроенных инструментов и библиотек
