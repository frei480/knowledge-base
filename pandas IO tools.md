...
* level name in a MultiIndex, with default name  ``level_0``, ``level_1``, вЂ¦ if not provided.
...
.. code-block:: text
    ...
    test
    в”њв”Ђв”Ђ a=0
    в”‚   в”њв”Ђв”Ђ 0bac803e32dc42ae83fddfd029cbdebc.parquet
    в”‚   в””в”Ђв”Ђ  ...
    в””в”Ђв”Ђ a=1
        в”њв”Ђв”Ђ e6ab24a4f45147b49b54a662f0c412a3.parquet
        в””в”Ђв”Ђ ...
...
.. code-block:: ipython
   ...
   3.29 s В± 43.2 ms per loop (mean В± std. dev. of 7 runs, 1 loop each)

   In [5]: %timeit test_hdf_fixed_write(df)
   19.4 ms В± 560 Вµs per loop (mean В± std. dev. of 7 runs, 1 loop each)

   In [6]: %timeit test_hdf_fixed_write_compress(df)
   19.6 ms В± 308 Вµs per loop (mean В± std. dev. of 7 runs, 10 loops each)

   In [7]: %timeit test_hdf_table_write(df)
   449 ms В± 5.61 ms per loop (mean В± std. dev. of 7 runs, 1 loop each)

   In [8]: %timeit test_hdf_table_write_compress(df)
   448 ms В± 11.9 ms per loop (mean В± std. dev. of 7 runs, 1 loop each)

   In [9]: %timeit test_csv_write(df)
   3.66 s В± 26.2 ms per loop (mean В± std. dev. of 7 runs, 1 loop each)

   In [10]: %timeit test_feather_write(df)
   9.75 ms В± 117 Вµs per loop (mean В± std. dev. of 7 runs, 100 loops each)

   In [11]: %timeit test_pickle_write(df)
   30.1 ms В± 229 Вµs per loop (mean В± std. dev. of 7 runs, 10 loops each)

   In [12]: %timeit test_pickle_write_compress(df)
   4.29 s В± 15.9 ms per loop (mean В± std. dev. of 7 runs, 1 loop each)

   In [13]: %timeit test_parquet_write(df)
   67.6 ms В± 706 Вµs per loop (mean В± std. dev. of 7 runs, 10 loops each)
...
.. code-block:: ipython
   ...
   1.77 s В± 17.7 ms per loop (mean В± std. dev. of 7 runs, 1 loop each)

   In [15]: %timeit test_hdf_fixed_read()
   19.4 ms В± 436 Вµs per loop (mean В± std. dev. of 7 runs, 10 loops each)

   In [16]: %timeit test_hdf_fixed_read_compress()
   19.5 ms В± 222 Вµs per loop (mean В± std. dev. of 7 runs, 10 loops each)

   In [17]: %timeit test_hdf_table_read()
   38.6 ms В± 857 Вµs per loop (mean В± std. dev. of 7 runs, 10 loops each)

   In [18]: %timeit test_hdf_table_read_compress()
   38.8 ms В± 1.49 ms per loop (mean В± std. dev. of 7 runs, 10 loops each)

   In [19]: %timeit test_csv_read()
   452 ms В± 9.04 ms per loop (mean В± std. dev. of 7 runs, 1 loop each)

   In [20]: %timeit test_feather_read()
   12.4 ms В± 99.7 Вµs per loop (mean В± std. dev. of 7 runs, 100 loops each)

   In [21]: %timeit test_pickle_read()
   18.4 ms В± 191 Вµs per loop (mean В± std. dev. of 7 runs, 100 loops each)

   In [22]: %timeit test_pickle_read_compress()
   915 ms В± 7.48 ms per loop (mean В± std. dev. of 7 runs, 1 loop each)

   In [23]: %timeit test_parquet_read()
   24.4 ms В± 146 Вµs per loop (mean В± std. dev. of 7 runs, 10 loops each)
